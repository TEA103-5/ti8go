...
<title>遊記內編資料修改 - update_noteC_input.jsp</title>
...
<body bgcolor='white'>
	...
	<table id="table-1">
		<tr>
			<td>
				<h3>遊記資料修改 - update_noteC_input.jsp</h3>
				<h4>
	...
	<FORM METHOD="post" ACTION="notec.do" name="form1"
		enctype="multipart/form-data">
		<table>
			<tr>
				<td>內編序號:<font color=red><b>*</b></font></td>
				<td><%=noteCVO.getNote_c_id()%></td>
			</tr>
			<tr>
				<td>副標題:</td>
				<td><input type="TEXT" name="note_c_title" size="45"
					value="<%=noteCVO.getNote_c_title()%>" /></td>
			</tr>
			<tr>
				<td>內容:</td>
				<td><input type="TEXT" name="note_c_content" size="45"
					value="<%=noteCVO.getNote_c_content()%>" /></td>
			</tr>
			<tr>
				<td>附加圖片:</td>
				<td><input type="FILE" class="upload" name="note_c_img"
					accept=image/*></td>
				<td><img
		...
		<br> <input type="hidden" name="action" value="update"> <input
			type="hidden" name="note_c_id" value="<%=noteCVO.getNote_c_id()%>">
