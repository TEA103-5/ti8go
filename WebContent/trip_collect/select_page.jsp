...
<head>
<meta charset="UTF-8">
<title>Tivago Trip_collect: Home</title>
...
<table id="table-1">
	<tr><td><h3>Tivago Trip_collect: Home</h3><h4>( MVC )</h4></td></tr>
</table>

<p>This is the Home page for Tivago Trip_collect: Home</p>
...
<ul>
	<li><a href='listAllTrip_collect.jsp'>List</a> all Trip_collect.  <br><br></li>
	...
	<li>
	    <FORM METHOD="post" ACTION="trip_collect.do" >
	        <b>查詢某筆特定的收藏:</b>
	        <input type="text" name="trip_id" placeholder="請輸入行程編號">
...
<%-- 				<c:forEach var="trip_collectVO" items="${trip_collectSvc.all}"> --%>
<%-- 					<option value="${trip_collectVO.users_id}">${trip_collectVO.users_id} --%>
<%-- 				</c:forEach> --%>
...
<ul>
  <li><a href='addTrip_collect.jsp'>Add</a> a new Trip_collect.</li>
</ul>
