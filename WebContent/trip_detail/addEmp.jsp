...
<title>行程明細資料新增 - addTrip_detail.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>行程明細資料新增 - addTrip_detail.jsp</h3></td><td>
		 <h4><a href="<%=request.getContextPath()%>/trip_detail/select_page.jsp"><img src="images/tomcat.png" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<%-- 		<td><input type="TEXT" name="trip_detail_type" size="45"  value="<%=trip_detailVO.getTrip_detail_type()%>" /></td> --%>
		...
		<option value="<%= (trip_detailVO==null)? "其他" : trip_detailVO.getTrip_detail_type()%>">${ trip_detailVO.getTrip_detail_type()}
		<option value="景點">景點
		<option value="餐廳">餐廳
		<option value="飯店">飯店
		<option value="交通">交通
...
<!-- 	</tr> -->
	...
	<tr>
		...
		value="<%= (trip_detailVO==null)? "無" :trip_detailVO.getTrip_remarks()%>" /></td>
	</tr>
