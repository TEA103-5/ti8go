...
<table id="table-1">
   <tr><td><h3>IBM Note: Home</h3><h4>( MVC )</h4></td></tr>
</table>

<p>This is the Home page for IBM Note: Home</p>
...
<ul>
  <li><a href='listAllNote.jsp'>查詢List</a> all Notes.  <br><br></li>
...
<ul>
  <li><a href='addNote.jsp'>新增Add</a> a new Note.</li>
</ul>
