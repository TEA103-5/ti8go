						...
						<c:forEach var="cardVO" items="${list}" >
							...
							<tr class="card_list">
								...
								<td><p class="para">${cardVO.card_last}</p>
										...
										<input type="hidden" class="up_btn" value="送出修改">
<!-- 										<input type="submit" class="up_btn" value="送出修改"> -->
								</form>
								<td>
									<button type="button" class="btn btn-primary" id="btu_update">
									修改	
									</button>
								</td>
								<td>
