...
<table id="table-1">
	<tr><td>
		 ...
		 <h4><a href="<%=request.getContextPath()%>/front-end/users/select_page.jsp"><img src="images/tomcat.png" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<table>
	<tr>
		...
		<td><input type="TEXT" name="users_name" size="15" 
			 value="<%= (usersVO==null)? "會員假" : usersVO.getUsers_name()%>" /></td>
	</tr>
	<tr>
		<td>暱稱:</td>
	...
	<tr>
		...
		<td><input type="password" name="users_pwd" size="20"
			 value="<%= (usersVO==null)? "444555666" : usersVO.getUsers_pwd()%>" /></td>
	</tr>
	<tr>
		<td>生日:</td>
