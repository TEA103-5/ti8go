                ...
                <form id="insert_form" METHOD="post" ACTION="<%=request.getContextPath()%>/place/place.do" name="form1" enctype="multipart/form-data"> 
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
							...
							<img id="pic1" width="300"
								height="225" src="<%=request.getContextPath()%>/place/DBGifReader4.do">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
    ...
    <script>
	    ...
	    function init() {
	        tcs = new TwCitySelector({
	            ...
	            bootstrapStyle: true,
	            standardWords: true,
	            // countyValue: '臺北市' // 此處需用正體字的臺 , 這一項可以設定預設的縣市
	        });
	    }
	        init();
