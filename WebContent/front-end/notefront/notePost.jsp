        ...
        <section class="clean-block clean-post dark">
            <div class="container">
                <div class="block-content">
                    <div class="post-image" style="background-image:url(&quot;<%=request.getContextPath()%>/front-end/notefront/assets/img/scenery/image1.jpg&quot;);"></div>
                    <div class="post-body">
                        <h3><font size="7">${noteVO.note_title}</font></h3>
                        ...
                        <c:forEach var="noteCVO" items="${Clist}" >
                                <figure class="figure"><img class="rounded img-fluid figure-img" src="<%=request.getContextPath()%>/DBGifReaderNoteC?note_c_id=${noteCVO.note_c_id}"
										style="width: 400px; height: 300px;" alt="A generic square placeholder image with rounded corners in a figure.">
