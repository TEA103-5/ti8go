...
<head>
    ...
    <link rel="stylesheet" href="/TEA103G5/front-end/assets/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Montserrat:400,400i,700,700i,600,600i">
    <link rel="stylesheet" href="/TEA103G5/front-end/assets/fonts/simple-line-icons.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/baguettebox.js/1.10.0/baguetteBox.min.css">
    <link rel="stylesheet" href="/TEA103G5/front-end/assets/css/smoothproducts.css">
        ...
        <div class="container"><a class="navbar-brand logo" href="#">Tivago</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a class="nav-link" href="/TEA103G5/front-end/">首頁</a></li>
        ...
        <section class="clean-block clean-catalog dark">
            <div class="container">
                <div class="block-heading">
                    <h2 class="text-info">listAllProduct.jsp</h2>
...
begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>" 
	>
            ...
            <div class="rating"><img src="/TEA103G5/front-end/assets/img/star.svg"><img src="/TEA103G5/front-end/assets/img/star.svg"><img src="/TEA103G5/front-end/assets/img/star.svg"><img src="/TEA103G5/front-end/assets/img/star-half-empty.svg"><img src="/TEA103G5/front-end/assets/img/star-empty.svg"></div>
            <div class="product-name"><a href="#">${empVO.product_name}</a></div>
            <img class="img-fluid d-block mx-auto img" src="<%=request.getContextPath()%>/DBGifReader4_1?id=${empVO.product_id}&id2=p"></a></div>
                                            <div class="about">
                                                <div class="price">
...
<!--                                 </nav> -->
    ...
    <script src="/TEA103G5/front-end/assets/js/jquery.min.js"></script>
    <script src="/TEA103G5/front-end/assets/bootstrap/js/bootstrap.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/baguettebox.js/1.10.0/baguetteBox.min.js"></script>
    <script src="/TEA103G5/front-end/assets/js/smoothproducts.min.js"></script>
    <script src="/TEA103G5/front-end/assets/js/theme.js"></script>
</body>
</html>