...
public class SaleDAO implements SaleDAO_interface {
	...
	private static final String GET_Prods_BySaleid_STMT = "SELECT product_id,product_name,PRODUCT_Status,PRODUCT_Content,PRODUCT_Description,PRODUCT_Categories,PRODUCT_Price,PRODUCT_Stock,sale_id,product_update_time FROM product where sale_id = ? and PRODUCT_Status=1 order by product_id";
